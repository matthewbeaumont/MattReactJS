// If just raw javascript use a .js file. For JSX use the .jsx files. SInce the file is contained inside a React project it can regonginse JSX within a .js file but it is best practice to use the correct file type. 

// import React from "react" allows the code below this to make use of react JavaScript libraries and recognise the code as using react syntax. note that "react" isn't give a filepath. In cases where a filepath isn't specified it will be asuemd that it is imported from the node modules folder containing the javascript packages.
import React from "react";
// in this component I need to import another component "Header2" that I nested inside the "Header" component.
import Header2 from "./Header2"

// The below "Header" needs to be capitalised to make sure it is recognised as a component. Line 7 is the component. For good practice we use one component per file. It can be possible to have multipl ecomponents in a file. 
function Header() {
 return(
